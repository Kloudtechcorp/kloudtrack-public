...
export interface InfoCardStationData {
  ...
  data: {
    current: InfoCardWeatherData | InfoCardCoastalData | InfoCardRainData | InfoCardRiverData;
    previous: (InfoCardWeatherData | InfoCardCoastalData | InfoCardRainData | InfoCardRiverData)[];
  };
}
